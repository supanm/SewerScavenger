    ...
    public class BattleTile
    {
        ...
        public string GetAllInfo()
        {
            ...
            if (Type == "Monster")
            {
                ...
                compile += "Experience  : " + Enemy.ExpToGive + "\n\n";
        ...
        // Returns the current XP for characters and currect ExpToGive for monsters.
        public int GetExperience()
        {
            if (Type == "Monster")
            {
                return Enemy.ExpToGive;
            }
            else if (Type == "Character")
            {
                return Hero.XP;
