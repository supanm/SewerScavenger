...
namespace SewerScavenger.Models
{
    ...
    public class Item : Entity<Item>
    {
        ...
        // Empty item constructor. Had a hard time with nulls on the equipment so this serves as an empty slot
        public Item()
        {
            Name = "Unknown";
            Description = "Unknown";
        ...
        // Constructor for a new instance of an item with the same stats.
        public Item(Item i)
        {
            Name = i.Name;
        ...
        // Constructor for an exact item specification. 
        ...
        // Creates a JSON formatted string of an item
        ...
        // Turn this item instance into the same item as the parameter
